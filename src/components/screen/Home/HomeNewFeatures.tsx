          ...
          <ul className="mt-[3.2rem] md:mt-[6rem] flex gap-[2.4rem] md:gap-[3rem] flex-col md:flex-row">
            {newFeaturesData.map((item: NewFeaturesType) => {
              return (
                ...
                >
                  <article>
                    <h3 className="bg-[linear-gradient(281.71deg,_#96CB02_16.78%,_#FAB222_73.53%)] inline-block text-transparent bg-clip-text font-bold text-[1.746rem] md:text-[2.4rem]">
                      {item.title}
                    </h3>
